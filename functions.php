...
function zaimozon_scripts() {
	wp_enqueue_style( 'zaimozon-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'zaimozon-style', 'rtl', 'replace' );

	wp_enqueue_script( 'zaimozon-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
